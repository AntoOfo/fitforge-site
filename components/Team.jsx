    ...
    return (
        <section className="w-full py-20 font-[Poppins]">
            <div className="ml-32 mr-32">
                ...
                <div className="flex">
                    <div className="w-[223px] h-[455px] rounded-[134px] bg-[rgba(239,239,239,1)]">
                        ...
                        <p className="font-medium text-[16px] text-[rgba(0,0,0,0.6)]">Built this legacy on the belief that consistent effort yields uncompromising strength.</p>
                    </div>
                </div>
            </div>
        </section>
