                    ...
                    {membershipData.map(membership => (
                        <div className="mt-12 px-5 py-6 rounded-2xl bg-white">
                            ...
                            <span className="mt-[3px] mb-0.5 flex items-baseline">
                                <h1 className="font-bold text-[64px] text-[rgba(192,57,43,1)]">£{membership.price}</h1>
                                <p className="font-medium text-[20px] text-[rgba(0,0,0,0.7)]">/month</p>
                            </span>
                            <p className="font-medium text-[20px] w-[355px] text-[rgba(0,0,0,0.7)]">{membership.desc}</p>
